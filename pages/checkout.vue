                        ...
                        <form @submit.prevent="pay()">
                            ...
                            <button
                                ...
                                class="
                                    ...
                                    cursor-pointer
                                "
                                :class="isProcessing ? 'opcaity-70' : 'opacity-100'"
                            >
<!--                                <Icon v-if="isProcessing" name="eos-icons:loading"/>-->
                    ...
                    <div class="bg-white rounded-lg p-4 mt-4">
                        <div class="text-lg font-semibold mb-2 mt-2">FlyShop</div>
                        <p class="my-2">
                            FlyShop keeps your information and payment safe
                        </p>
                    </div>
                </div>
            </div>
...
const showError = (errorMsgText) => {
    ...
    setTimeout(() => { errorMsg.textContent = "" }, 1000);
};
