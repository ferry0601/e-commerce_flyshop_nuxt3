<template>
    <MainLayout>
        <div id="OrderPage" class="mt-4 max-w-[1200px] mx-auto px-2 min-h-[50vh]">
            <div class="bg-white w-full p-6 min-h-[150px]">
                ...
                <div 
                    ...
                    v-for="order in orders.data" :key="order"
                ...
                >
                    <div class="border-b py-1">
                        ...
                        <div v-for="item in order.orderItem" :key="item">
                            <NuxtLink 
                                class="flex items-center gap-3 p-1 hover:underline hover:text-blue-200"
